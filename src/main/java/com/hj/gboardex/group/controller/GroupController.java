package com.hj.gboardex.group.controller;

import com.hj.gboardex.group.domain.*;
import com.hj.gboardex.group.service.GroupService;
...
public class GroupController {
    ...
    public @ResponseBody String removeArticle(
    ...
    public @ResponseBody String createInviteCode (
            HttpServletResponse response,
            HttpServletRequest request) throws Exception{
        MainVO mainVO = (MainVO) request.getSession().getAttribute("currentGroup");
        SubscribeVO subscribeVO = new SubscribeVO();
